            ...
            <div class="row justify-content-center">
                <div class="col-12 col-sm-10 col-lg-8">
                    <div class="nl-content text-center">
                        ...
                        <p>To get the Latest update on our product and news update Suscribe to our newsletter.</p>
                    </div>
                </div>
            </div>
        </div>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved || Heat Finance &amp; Investments. </a>
                            </p>
