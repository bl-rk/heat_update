                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-service-area d-flex mb-100">
                        ...
                        <div class="text">
                            ...
                            <p>We dont need too much paper work to serve you as your convinience is our master plan.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-service-area d-flex mb-100">
                        ...
                        <div class="text">
                            ...
                            <p>We finance you with low interest rate also without terms and condition.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-service-area d-flex mb-100">
                        ...
                        <div class="text">
                            ...
                            <p>Lets invest in your buisness and make your dream come true we are transparent in our services</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="special-feature-content section-padding-100">
            <div class="feature-text">
                ...
                <div class="section-heading white mb-50">
                    <div class="line"></div>
                    <p>Heat finance & Investment</p>
                    <h2>Easy and Fast credits</h2>
                </div>
                <h6>Did you know you can actually get finance and investment in less than 24hours. With Heat finance & Investment we make your dream comes true as fast as you can imagine</h6>
        ...
        <div class="special-feature-content section-padding-100">
            <div class="feature-text">
                ...
                <div class="section-heading white mb-50">
                    <div class="line"></div>
                    <p>Heat loans</p>
                    <h2>Are you thinking of Getting loans?</h2>
                </div>
                <h6>Our loan is as swift as possible there is no limit to your possibilities of getting loans with us,Heat loans of fer loans at the lowest intrest rate ever which makes us the leading financial company.</h6>
