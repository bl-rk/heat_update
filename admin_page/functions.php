<?php 
	...
	// variable declaration for services content
	...
	// call the service() function if service_btn is clicked
...
// statement to logout current user/admin 
	...
	{
		$title =  e($_POST['title']);
		$content_text =  e($_POST['content_text']);
		$image  =  e($_POST['image']);
